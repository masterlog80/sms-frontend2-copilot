...
This repo's build/deploy logic lives in the shared [`masterlog80/homelab-scripts`](https://github.com/masterlog80/homelab-scripts) script. Set the variables below for this repo, then run it:

```bash
export REPO="masterlog80/sms-frontend2-copilot"
export DIRNAME="sms-frontend2-copilot"
export REGISTRY="zot.salvetti.info"
export IMAGE_NAME="modem-dashboard"
